  ...
  if((document.getElementById('a1').checked)==false && (document.getElementById('a2').checked)==false) {   
               ...
               else
              {
                ...
                if(parseInt(m_age2[e].value)>100||(m_age2[e].value)=="")
                {
      ...
      function radio_click()
        ...
        function AddTextBox(x) {
          ...
          for(i=0;i<x;i++)
          {
            ...
            div.innerHTML =  "Enter name  <br>"+'<input class="form-control m_name"  name = "DynamicTextBox"  type="text" />'+'<div class="m_div1" style="font-size: small; font-family: Georgia; "></div>'+
             "<br>Enter age <br>"+'<input type="number" class="form-control m_age min="1" max="100"" name="myn">'+'<div class="m_div2" style="font-size: small; font-family: Georgia; "></div>'+
            "<br>Enter gender:&nbsp&nbsp&nbsp   "+"<input type='radio' class='strg1'  name=str onclick='radio_group()' >Yes"+
            "&nbsp&nbsp<input type='radio'class='strg2'  id='str2' onclick='radio_group()' name=str value='NO'>No"+'<div class="m_div3" style="font-size: small; font-family: Georgia; "></div>'+
            "<br>Enter occupation <br>"+'<input type="text" class="form-control m_occup"  name="headoccupation" onkeyup ="add_check()">'+'<div class="m_div4" style="font-size: small; font-family: Georgia; "></div>'+'<BR><BR><BR>' ;
